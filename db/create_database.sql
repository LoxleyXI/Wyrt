...
CREATE TABLE IF NOT EXISTS characters (
    id INT AUTO_INCREMENT PRIMARY KEY,
    account_id INT NOT NULL,
    game_id VARCHAR(50) NOT NULL, -- 'ironwood', 'tilegame', etc.
...
CREATE TABLE IF NOT EXISTS tilegame_stats (
    character_id INT PRIMARY KEY,
    hp INT DEFAULT 100,
    max_hp INT DEFAULT 100,
    mp INT DEFAULT 50,
...
-- Tile game inventory
CREATE TABLE IF NOT EXISTS tilegame_inventory (
    id INT AUTO_INCREMENT PRIMARY KEY,
    character_id INT NOT NULL,
    item_id VARCHAR(100) NOT NULL,
    quantity INT DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS tilegame_abilities (
    character_id INT NOT NULL,
